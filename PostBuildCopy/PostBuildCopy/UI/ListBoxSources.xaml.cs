...
namespace PostBuildCopy.UI
{
    ...
    public partial class Sources : UserControl
    {
        ...
        public void InitializeEvent()
        {
            ...
            lbSources.OnAllowDrop +=lbSources_OnAllowDrop;
        }

        private bool lbSources_OnAllowDrop(int id)
        {
        ...
        private void ListBoxSource_OnPathDrop(string iNodeDropped)
        {
            if (null != iNodeDropped)
            {
                if (false == HasItem(Destinations.s_IndexDestination))
                    return;
                PathDataModel PathData = new PathDataModel(iNodeDropped);
        ...
        public bool HasItem(int indexDest)
        {
            if (-1 == indexDest)
            {
